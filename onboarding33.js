...
const letterbase_one = document.querySelector('.letterbase.one');
const letterbase_two = document.querySelector('.letterbase.two');
const letterbase_three = document.querySelector('.letterbase.three');
const letterbase_four = document.querySelector('.letterbase.four');
const front_flap = document.querySelector('.front.flap');
const front_pocket = document.querySelector('.front.pocket');
...
function caseInSwitch(val) {
    switch(val) {
        ...
        case 4: 
            ...
            tick_step_4.forEach(tickcontainer4 => {
              tickcontainer4.classList.remove('onopacity');
                 });

            circle_step_4.forEach(circlestep4 => {
              circlestep4.classList.remove('offopacity');
                 });
            ...
            const letterbase_one = document.querySelectorAll('.letterbase.letterone');
            const letterbase_two = document.querySelectorAll('.letterbase.lettertwo');
            const letterbase_three = document.querySelectorAll('.letterbase.letterthree');
            const letterbase_four = document.querySelectorAll('.letterbase.letterfour');
            const front_flap = document.querySelectorAll('.front.flap');
            const front_pocket = document.querySelectorAll('.front.pocket');
            const close = document.querySelectorAll('.close');
            const submit_button = document.querySelectorAll('.submitbutton4');
            
            tick_step_4.forEach(tickcontainer4 => {
              tickcontainer4.classList.add('onopacity');
                 });
            
            circle_step_4.forEach(circlestep4 => {
              circlestep4.classList.add('offopacity');
              });

            letterbase_one.forEach(letterone =>{
              letterone.classList.add('letteroneplay');
            });

            letterbase_two.forEach(letterone =>{
              letterone.classList.add('lettertwoplay');
            });

            letterbase_three.forEach(letterone =>{
              letterone.classList.add('letterthreeplay');
            });

            letterbase_four.forEach(letterone =>{
              letterone.classList.add('letterfourplay');
            });

            front_flap.forEach(flap =>{
              flap.classList.add('flapplay');
            });

            front_pocket.forEach(pocket =>{
              pocket.classList.add('pocketplay');
            });

            close.forEach(close =>{
              close.classList.add('closeplay');
            });

            submit_button.forEach(submitbutton4 =>{
              submitbutton4.classList.add('submitplay');
            });
            ...
            const row_timeline = document.querySelectorAll('.rowtimeline');
            const row_text = document.querySelectorAll('.rowtext');
            ...
            function final(){
              ...
              rowtimeline.classList.add('offopacity');
            });
