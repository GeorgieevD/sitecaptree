...
function caseInSwitch(val) {
    switch(val) {
        ...
        case 4: 
            ...
            const letterbase_two = document.querySelectorAll('.letterbase.two');
            const letterbase_three = document.querySelectorAll('.letterbase.three');
            const letterbase_four = document.querySelectorAll('.letterbase.four');
