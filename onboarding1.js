...
function caseInSwitch(val) {
    switch(val) {
        ...
        case 3: 
          ...
          setTimeout(progress5, 200);
          setTimeout(progress6, 400);
          setTimeout(progress7, 600);
          setTimeout(progress8, 800);
        ...
        case 4: 
              ...
              setTimeout(progress9, 200);
              setTimeout(progress10, 400);
              setTimeout(progress11, 600);
              setTimeout(progress12, 800);
