...
submit_button_click.addEventListener('click', () => {
  ...
  letter_one_dupe.classList.add('letteroneplay2');

  letter_two_dupe.classList.add('lettertwoplay2');

  letter_three_dupe.classList.add('letterthreeplay2');

  front_flapdupe.classList.add('closeflap');
...
const letterbase_one = document.querySelector('.letterbase.letterone');
const letterbase_two = document.querySelector('.letterbase.lettertwo');
const letterbase_three = document.querySelector('.letterbase.letterthree');
const letterbase_four = document.querySelector('.letterbase.letterfour');
...
let dotTimer;
            ...
            letterbase_one.classList.add('letteroneplay');
           
            letterbase_two.classList.add('lettertwoplay');

            letterbase_three.classList.add('letterthreeplay');

            letterbase_four.classList.add('letterfourplay');

            front_flap.classList.add('flapplay');

            front_pocket.classList.add('pocketplay');

            close.classList.add('closeplay');

            submit_button.classList.add('submitplay');

            back_button.forEach(back_button => {
              back_button.classList.add('submitplay');
            });


            dot.forEach(dot => {
              dot.classList.add('godots');
            });

            dotTimer = setTimeout(hidedots,7000)
