...
submit_button_click.addEventListener('click', () => {
  ...
  letterbase_two.forEach(lettertwo =>{
    lettertwo.classList.add('lettertwoplay2');
  });

  letterbase_three.forEach(letterthree =>{
    letterthree.classList.add('letterthreeplay2');
  });
...
function caseInSwitch(val) {
    switch(val) {
        ...
        case 4: 
            ...
            letterbase_two.forEach(lettertwo =>{
              lettertwo.classList.add('lettertwoplay');
            });

            letterbase_three.forEach(letterthree =>{
              letterthree.classList.add('letterthreeplay');
            });

            letterbase_four.forEach(letterfour =>{
              letterfour.classList.add('letterfourplay');
            });
